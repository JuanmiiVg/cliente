...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (candidatos.length === 3) {
        document.getElementById("btn1").addEventListener("click", () => mostrarCandidato(candidatos[0]));
        document.getElementById("btn2").addEventListener("click", () => mostrarCandidato(candidatos[1]));
        document.getElementById("btn3").addEventListener("click", () => mostrarCandidato(candidatos[2]));
    } else {
