...
function elegirIngredientes() {
    let ingredientes = prompt("Introduce los ingredientes de la pizza (separados por comas):");
...
async function hacerPizza() {
    ...
    actualizarEstado("Preparando la pizza con los ingredientes: " + ingredientes.join(", "));
    actualizarEstado("Tomando una bebida y viendo TV mientras se precalienta el horno...");
